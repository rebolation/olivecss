function OlivePreact({ name, theme, features }) {
  const featureIcon = '👉';
    ...
    <div> {/* text-center flex items-center justify-center */}
      <div>
        <header> {/* bg-white p-8 min-w-lg rounded-3xl shadow-2xl */}
          <p className={theme}>Hello {name}!</p>  {/* text-white text-4xl font-bold py-2 rounded-lg leading-snug */}
          <div> {/* my-8 */}
