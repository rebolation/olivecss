...
export class OliveCSSApp extends LitElement {
  ...
  render() {
    const { title, subtitle, features, featureIcon } = this.text;
        ...
        <div>
          <header> <!-- bg-white p-12 min-w-lg rounded-3xl shadow-2xl -->
            ...
            <div> <!-- bg-gray-100 px-4 py-2 mb-5 rounded-lg -->
              <p>&lt;!-- backgroundColor: olive; color:white; --&gt; </p> <!-- background-color: olive; color:white; --> <!-- rounded-sm -->
              ...
              <p>&lt;!-- // double-slash for a commen --&gt;</p> <!-- bg-lime-900 text-white -->
...
customElements.define('olivecss-app', OliveCSSApp);
